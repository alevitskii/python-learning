    ...
    for _ in range(len(graph)):
        ...
        for current_vertex in range(vertex_count):
            if (
                ...
                and dist[current_vertex] > dist[min_dist_vertex] + graph[min_dist_vertex][current_vertex]
            ):
                dist[current_vertex] = dist[min_dist_vertex] + graph[min_dist_vertex][current_vertex]
    return dist
